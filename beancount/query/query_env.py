...
class ToDecimal(query_compile.EvalFunction):
    ...
    def __call__(self, context):
        ...
        # ToDecimal has no default value, but ToDecimalDefault will pass a default value as the second arg
...
class ToDecimalDefault(ToDecimal):
    "Converts a string into a Decimal type, defaulting to second argument if input is not parseable as decimal"
